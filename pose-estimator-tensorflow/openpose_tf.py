...
nPoints = 18
CocoPairs = [(1, 2), (1, 5), (2, 3), (3, 4), (5, 6), (6, 7), (1, 8), (8, 9), (9, 10), (1, 11),
...
def show_fps(frame):
    if not args.image:
        ...
        cv.putText(frame, fps_label, (5, 15), cv.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 255), 2)
...
if __name__ == "__main__":
    ...
    while cv.waitKey(1) < 0:
        ...
        # frame = cv.resize(frame, (winWidth, winHeight))
        if not has_frame:
            cv.waitKey(3000)
            break
